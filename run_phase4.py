...
def main() -> None:
    ...
    euler_config = SU2NozzleConfig(total_pressure=10e6, total_temperature=3500.0)
    rans_config = SU2RANSConfig(total_pressure=10e6, total_temperature=3500.0)
    ...
    # Generate mesh
    print("\n[1/4] Generating mesh...")
    mesh_path = generate_nozzle_mesh(nozzle_config, output_file=str(workdir / "nozzle.su2"))
    print(f"  Mesh: {mesh_path}")

    # Run Euler (reference)
    print("\n[2/4] Running Euler simulation...")
    solver = SU2Solver()
