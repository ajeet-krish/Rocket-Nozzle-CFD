...
CONFIG = EngineConfig(
    ...
    theta_n=20,  # Preset value: 20 matches geometry better than 25
    ld=None,  # Use preset diverging_length (2.5m)
    euler_n_axial=80,  # Optimized: 80x40 is stable; 60x30 diverges, 100x50+ won't converge
    euler_n_normal=40,
    euler_cfl=0.03,  # Lower CFL for stability with 285:1 expansion
