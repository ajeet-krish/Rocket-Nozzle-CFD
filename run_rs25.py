...
CONFIG = EngineConfig(
    ...
    theta_n=25,  # Optimized: 25 gives 2.15% error vs 30 (8.73% error)
    ld=None,  # Use preset diverging_length (2.0m)
    euler_n_axial=60,  # Optimized: 60x30 gives 2.15% error vs 40x20 (10.75%)
    euler_n_normal=30,
    euler_cfl=0.05,  # Stable at 0.05 with 60x30 mesh
